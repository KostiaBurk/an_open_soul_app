...
export interface TaskContext {
     ...
     * system-generated id.
     * This is the "my-ta***REMOVED***id" value in the complete task name, such as "task_name =
     * projects/my-project-id/locations/my-location/queues/my-queue-id/tasks/my-ta***REMOVED***id."
